...
class ObservationPeriodObject(OutputClass):
    def fields(self):
        return ["observation_period_id", "person_id", "observation_period_start_date", "observation_period_start_datetime", "observation_period_end_date", "observation_period_end_datetime", "period_type_concept_id"]
...
class DeviceExposureObject(OutputClass):
    def fields(self):
        return ["device_exposure_id", "person_id", "device_concept_id", "device_exposure_start_date", "device_exposure_start_datetime", "device_exposure_end_date", "device_exposure_end_datetime", "device_type_concept_id", "unique_device_id", "quantity", "provider_id", "visit_occurrence_id", "device_source_value", "device_source_concept_id"]
...
class NoteObject(OutputClass):
    def fields(self):
        return ["note_id", "person_id", "note_date", "note_datetime", "note_type_concept_id", "note_class_concept_id", "note_title", "note_text", "encoding_concept_id", "language_concept_id", "provider_id", "visit_occurrence_id", "note_source_value"]
...
class ProcedureOccurrenceObject(OutputClass):
    def fields(self):
        return ["procedure_occurrence_id", "person_id", "procedure_concept_id", "procedure_date", "procedure_datetime", "procedure_type_concept_id", "modifier_concept_id", "quantity", "provider_id", "visit_occurrence_id", "procedure_source_value", "procedure_source_concept_id", "qualifier_source_value"]
