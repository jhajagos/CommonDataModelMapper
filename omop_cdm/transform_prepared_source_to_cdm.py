...
def main(input_csv_directory, output_csv_directory, json_map_directory):
    ...
    visit_detail_rules = [
        ...
        ("s_start_datetime", SplitDateTimeWithTZ(),
         {"date": "visit_detail_start_date", "time": "visit_detail_start_time"}),
        ("s_start_datetime", DateTimeWithTZ(), {"datetime": "visit_detail_start_datetime"}),
        (("s_end_datetime", "s_start_datetime"), CascadeMapper(
                                 ...
                                 ChainMapper(FilterHasKeyValueMapper(["s_start_datetime"]),
                                             SplitDateTimeWithTZ())),
                              {"date": "visit_detail_end_date", "time": "visit_detail_end_time"}),
        (("s_end_datetime",), DateTimeWithTZ(), {"datetime": "visit_detail_end_datetime"}),
        ...
        (":row_id", ConstantMapper({"visit_detail_type_concept_id": 0}), {"visit_detail_type_concept_id": "visit_detail_type_concept_id"})
    ]
